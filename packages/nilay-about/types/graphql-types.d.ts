...
export type SiteFieldsEnum = 
  ...
  | 'siteMetadata___social___facebookAppId'
  | 'siteMetadata___social___youtube'
  | 'siteMetadata___social___instagram'
  | 'siteMetadata___social___github'
  | 'siteMetadata___phoneNumber'
  | 'siteMetadata___emailAddress'
  | 'siteMetadata___location___prefecture'
  | 'siteMetadata___location___city'
  | 'siteMetadata___location___street'
  | 'port'
  | 'host'
  | 'polyfill'
  | 'pathPrefix'
...
export type SiteSiteMetadata = {
  ...
  location?: Maybe<SiteSiteMetadataLocation>;
};
...
export type SiteSiteMetadataFilterInput = {
  ...
  location?: Maybe<SiteSiteMetadataLocationFilterInput>;
};

export type SiteSiteMetadataLocation = {
  prefecture?: Maybe<Scalars['String']>;
  city?: Maybe<Scalars['String']>;
  street?: Maybe<Scalars['String']>;
};

export type SiteSiteMetadataLocationFilterInput = {
  prefecture?: Maybe<StringQueryOperatorInput>;
...
export type ComponentSeoQueryVariables = Exact<{ [key: string]: never; }>;


export type ComponentSeoQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'siteUrl' | 'image' | 'description'>
      & { social?: Maybe<Pick<SiteSiteMetadataSocial, 'twitter' | 'facebookAppId'>> }
    )> }> };

export type IndexContactQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexContactQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'emailAddress' | 'phoneNumber'>
      & { social?: Maybe<Pick<SiteSiteMetadataSocial, 'youtube' | 'twitter' | 'instagram' | 'github' | 'facebookAppId' | 'facebook'>> }
    )> }> };

export type IndexHomeQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexHomeQuery = { tanuki?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }> };

export type IndexNewsDetailQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexNewsDetailQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl' | 'image' | 'phoneNumber' | 'emailAddress'>
      & { social?: Maybe<Pick<SiteSiteMetadataSocial, 'twitter' | 'facebook' | 'facebookAppId' | 'youtube' | 'instagram' | 'github'>> }
    )> }> };
