...
import {InputPort,Interactor,Request,Response} from "../../use-case/contact-message-send"
...
class Component extends React.Component<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this._useCase = new Interactor(new ContactMessageGateway())
  }
  ...
  gotoNext = () => (e: React.MouseEvent<HTMLElement>) => {
    (async () => {
      ...
      try {
        const res: Response = await this._useCase.interact(req);
        this.setState({
          isLoading: false,
          successMessage: true,
          uuid: res.uuid,
