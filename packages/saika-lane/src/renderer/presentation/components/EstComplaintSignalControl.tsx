...
export function EstComplaintSignalControl({ isOpen, onClose, onActiveChange }: IncidentReportDialogProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Electronic target complaint" className="max-w-xl">
      {ruleProcedure && (
