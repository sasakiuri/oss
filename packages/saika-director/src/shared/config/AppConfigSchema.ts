...
export const AppConfigSchema = z.object({
  ...
  'timingEvidence.mode': z.enum(['DISABLED', 'ADVISORY', 'REQUIRED']).default('DISABLED'),
  'clockQuality.mode': z.enum(['DISABLED', 'ADVISORY', 'REQUIRED']).default('ADVISORY'),
  'timedTargetReadiness.windowEnforcement': z.enum(['DISABLED', 'ADVISORY', 'REQUIRED']).default('ADVISORY'),
  'timedTargetReadiness.boundedShotTiming': z.enum(['DISABLED', 'ADVISORY', 'REQUIRED']).default('ADVISORY'),
  'timedTargetReadiness.physicalSignals': z.enum(['DISABLED', 'ADVISORY', 'REQUIRED']).default('ADVISORY'),
  ...
  'resultPublication.requireObservationReviews': PersistedBooleanSchema.default(true),
  ...
  'resultPublication.requireEquipmentChecksComplete': PersistedBooleanSchema.default(true),
