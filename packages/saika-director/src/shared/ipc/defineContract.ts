...
/** @deprecated Use IpcErrorDto */
export type IpcError = IpcErrorDto;
...
/** @deprecated Use CommandResponseDto */
export type CommandResponse = CommandResponseDto;
...
/** A map of procedure names → ProcedureDef */
