...
/** Adds the ISSF 25m Rapid Fire Final Start Number tie-break audit value. */
export const migration049FinalStartNumberResolution: Migration = {
  version: 49,
  name: 'final_start_number_resolution',
  up(db) {
    db.exec(`
      ...
      ALTER TABLE final_control_entries RENAME TO final_control_entries_v48;
      ALTER TABLE final_control_decisions RENAME TO final_control_decisions_v48;
      ...
      SELECT * FROM final_control_decisions_v48;
      ...
      SELECT * FROM final_control_entries_v48;

      DROP TABLE final_control_entries_v48;
      DROP TABLE final_control_decisions_v48;
